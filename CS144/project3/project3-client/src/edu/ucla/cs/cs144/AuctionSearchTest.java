...
public class AuctionSearchTest {
	...
	throws AxisFault {
		...
		SearchResult[] basicResults = AuctionSearchClient.basicSearch(query, 0, 10000);
		...
		*/
                ...
                SearchResult[] spatialResults = AuctionSearchClient.spatialSearch("superman", region, 0, 200);
