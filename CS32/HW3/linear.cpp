...
int main()
{
	...
	double x[7] = { 10, 50, 40, 20, 50, 40, 30 };
	double y[3] = { 50, 30, 20 };
	cout << anyNegative(a, 5) << endl;
	cout << countNegatives(a, 5) << endl;
	cout << firstNegative(a, 5) << endl;
	cout << indexOfMin(a, 5) << endl;
	cout << includes(x, 7, y, 3) << endl;
