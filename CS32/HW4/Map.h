...
template<typename KeyType, typename ValueType>
bool combine(const Map<typename KeyType, typename ValueType>& m1, const Map<typename KeyType, typename ValueType>& m2, Map<typename KeyType, typename ValueType>& result);
...
template<typename KeyType, typename ValueType>
void subtract(const Map<typename KeyType, typename ValueType>& m1, const Map<typename KeyType, typename ValueType>& m2, Map<typename KeyType, typename ValueType>& result);
...
template<typename KeyType, typename ValueType>
Map<typename KeyType, typename ValueType>& Map<KeyType, ValueType>::operator=(const Map<typename KeyType, typename ValueType>& rhs)
{
	if (this != &rhs)
	{
		Map temp(rhs);
...
bool combine(const Map<typename KeyType, typename ValueType>& m1, const Map<typename KeyType, typename ValueType>& m2, Map<typename KeyType, typename ValueType>& result)
{
	...
	const Map<typename KeyType, typename ValueType>* bigger;
	const Map<typename KeyType, typename ValueType>* smaller;
	if (m1.size() >= m2.size())
	{
		bigger = &m1;
		smaller = &m2;
	...
	bool status = true;
	Map<typename KeyType, typename ValueType> res(*bigger);               // res starts as a copy of the bigger map
...
void subtract(const Map<typename KeyType, typename ValueType>& m1, const Map<typename KeyType, typename ValueType>& m2, Map<typename KeyType, typename ValueType>& result)
{
	...
	if (m1.size() <= m2.size())
	{
		...
		Map<typename KeyType, typename ValueType> res;
	...
	else
	{
		...
		Map<typename KeyType, typename ValueType> res(m1);
