...
public class Tuple implements Serializable {
    ...
    public Tuple(TupleDesc td) {
        ...
        this.m_tuple = new Field [td.numFields()];
    }
    ...
    public void setField(int i, Field f) {
    	...
    	this.m_tuple[i] = f;
    	//System.out.println(this.m_td.numFields());
    	//else if(i < this.m_td.numFields() && i < this.m_tuple.size())
    	//	this.m_tuple.set(i, f);
    ...
    public Field getField(int i) {
    	...
    	//if(this.m_tuple.isEmpty() || i >= this.m_tuple.size() || i < 0)
    	//{
    	//	return null;
    	//}
    ...
    {
    	Iterator<Field> i = Arrays.asList(this.m_tuple).iterator();
    	return i;
    	/*
