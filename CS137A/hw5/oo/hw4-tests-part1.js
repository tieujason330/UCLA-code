...
tests(JS,
  ...
  {
    name: '4DPoint',
    code: 'OO.declareClass("FourDeePoint", "ThreeDeePoint", ["t"]);\n' + 
          'OO.declareMethod("FourDeePoint", "initialize", function(_this, x, y, z, t) {\n' +
          '   OO.superSend("ThreeDeePoint", _this, "initialize", x, y, z);\n' +
          '   OO.setInstVar(_this, "t", t);\n' +
          '});\n' +
          'OO.getInstVar(OO.instantiate("FourDeePoint",1,2,3,4) , "x");',
    expected: 1
  },
  {
  ...
  {
    name: 'Calling superClass method',
    code:
          'OO.declareClass("A", "Object", ["value"]);\n\n' +
          'OO.declareMethod("A", "initialize", function(_this, value) {\n' +
          '  OO.setInstVar(_this, "value", value);\n' +
          '});\n\n' +
          'OO.declareMethod("A", "Hi", function(_this) {\n' +
          '  return "A says hi!";\n' +
          '});\n\n' +
          'OO.declareClass("B", "A", ["x"]);' +
          'OO.declareMethod("B", "initialize", function(_this, value, x) {\n' +
          '  OO.superSend("A", _this, "initialize", value);\n' +
          '  OO.setInstVar(_this, "x", x);\n' +
          '});\n\n' +
          'OO.superSend("A",OO.instantiate("B", 1, 2) , "Hi");',
    expected: 'A says hi!'
  },
  {
    name: 'Overwriting superClass method and calling it',
    code:
          'OO.declareClass("AA", "Object", ["value"]);\n\n' +
          'OO.declareMethod("AA", "initialize", function(_this, value) {\n' +
          '  OO.setInstVar(_this, "value", value);\n' +
          '});\n\n' +
          'OO.declareMethod("AA", "Hi", function(_this) {\n' +
          '  return "AA says hi!";\n' +
          '});\n\n' +
          'OO.declareClass("BB", "AA", ["x"]);\n\n' +
          'OO.declareMethod("BB", "initialize", function(_this, value, x) {\n' +
          '  OO.superSend("AA", _this, "initialize", value);\n' +
          '  OO.setInstVar(_this, "x", x);\n' +
          '});\n\n' +
          'OO.declareMethod("BB", "Hi", function(_this) {\n' +
          '  return "BB says hi!";\n' +
          '});\n\n' +
          'OO.send(OO.instantiate("BB", 1, 2) , "Hi");',
    expected: 'BB says hi!'
  },
    {
    name: 'Overwriting superClass method and calling super method',
    code:
          'OO.declareClass("Aa", "Object", ["value"]);\n\n' +
          'OO.declareMethod("Aa", "initialize", function(_this, value) {\n' +
          '  OO.setInstVar(_this, "value", value);\n' +
          ...
          '  return "Bb says hi!";\n' +
          '});\n\n' +
          'OO.superSend("Aa",OO.instantiate("Bb", 1, 2) , "Hi");',
    expected: 'Aa says hi!'
  },
  {
    name: 'Getting superClass variable',
    code:
          'OO.declareClass("AAA", "Object", ["value"]);\n\n' +
          'OO.declareMethod("AAA", "initialize", function(_this, value) {\n' +
          '  OO.setInstVar(_this, "value", value);\n' +
          '});\n\n' +
          'OO.declareClass("BBB", "AAA", ["x"]);\n' +
          'OO.declareMethod("BBB", "initialize", function(_this, value, x) {\n' +
          '  OO.superSend("AAA", _this, "initialize", value);\n' +
          '  OO.setInstVar(_this, "x", x);\n' +
          '});\n\n' +
          'OO.getInstVar(OO.instantiate("BBB", 1, 2) , "value");',
    expected: 1
  },
  {
    name: 'duplicate instance variable declaration',
    code:
          'OO.declareClass("z", "Object", ["value"]);\n\n' +
          'OO.declareMethod("z", "initialize", function(_this, value) {\n' +
          '  OO.setInstVar(_this, "value", value);\n' +
          '});\n\n' +
          'OO.declareClass("zz", "z", ["value","x"]);\n',
    shouldThrow: true
  },
  {
    name: 'method declaration and send',
