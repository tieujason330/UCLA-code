...
(* We define a polymorphic type to represent environments, which are
   mappings from names (strings) to items of some type.  This type can
   be instantiated with a type for items. *)
