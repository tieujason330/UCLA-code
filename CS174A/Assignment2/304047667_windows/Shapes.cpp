...
//
point4 vertices[8] = {
	point4(-0.5, -0.5, 0.5, 1.0), //vertices[0] - front bottom left
	point4(-0.5, 0.5, 0.5, 1.0), //vertices[1] - front top left
	point4(0.5, 0.5, 0.5, 1.0), //vertices[2] - front top right
	point4(0.5, -0.5, 0.5, 1.0), //vertices[3] - front bottom left

	// other 4 corners/vertices are missing
	// specify them here
	point4(0.5, -0.5, -0.5, 1), //vertices[4] - back bottom right
	point4(0.5, 0.5, -0.5, 1), //vertices[5] - back top right
	point4(-0.5, 0.5, -0.5, 1), //vertices[6] - back top left
	point4(-0.5, -0.5, -0.5, 1) //vertices[7] - back bottom left
    //end
...
void colorcube()
{
	...
	//top face
	quad(6, 1, 2, 5, point3(0.0f, 1.0f, 0.0f));
	//bottom face
	quad(7, 0, 3, 4, point3(0.0f, -1.0f, 0.0f));
    //right face
	quad(2, 3, 4, 5, point3(1.0f, 0.0f, 0.0f));
	//left face
	quad(6, 7, 0, 1, point3(-1.0f, 0.0f, 0.0f));
    //end
}
